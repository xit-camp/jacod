...
import camp.xit.jacoa.EntryMapper;
import camp.xit.jacoa.EntryMapping;
import camp.xit.jacoa.EntryMappings;
import camp.xit.jacoa.InvalidEntryException;
import camp.xit.jacoa.NotNull;
import static camp.xit.jacoa.impl.EntryMetadata.getReferenceType;
import camp.xit.jacoa.impl.FieldMap.FieldMapping;
import static camp.xit.jacoa.impl.ValueParser.*;
...
public final class CodelistEntryMapper implements EntryMapper {
    ...
    <T extends CodelistEntry> EntryMetadata getEntryMetadata(Class<T> clazz) {
