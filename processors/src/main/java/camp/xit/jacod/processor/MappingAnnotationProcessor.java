...
@SupportedAnnotationTypes({"camp.xit.jacod.annotation.BaseEntryMapping", "camp.xit.jacod.annotation.EntryMapping", "camp.xit.jacod.annotation.EntryMappings"}) // only constants are possible here
