...
public class InsuranceProduct extends CodelistEntry {
    ...
    public String toString() {
        return "InsuranceProduct{" + super.toStringAttrs() + ", type=" + type + ", company=" + company
                + ", rate=" + rate + ", ageFrom=" + ageFrom + ", ageTo=" + ageTo
                + ", ageAtRepayment=" + ageAtRepayment + ", description=" + description
                + ", insuranceCalculationType=" + insuranceCalculationType
